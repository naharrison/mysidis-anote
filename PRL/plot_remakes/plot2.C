...
hpipM_116->GetYaxis()->SetLabelSize(0.10);
...
hpipAc_116->GetYaxis()->SetLabelSize(0.11);
...
hpipAcc_116->GetYaxis()->SetLabelSize(0.11);
...
hpipM_117->GetYaxis()->SetLabelSize(0.11);
...
hpipAc_117->GetYaxis()->SetLabelSize(0.11);
...
hpipAcc_117->GetYaxis()->SetLabelSize(0.11);
...
hpipM_118->GetYaxis()->SetLabelSize(0.11);
...
hpipAc_118->GetYaxis()->SetLabelSize(0.11);
...
hpipAcc_118->GetYaxis()->SetLabelSize(0.11);
...
hpipM_119->SetTitle("");
hpipM_119->GetXaxis()->SetTitle("P_{hT}^{2} (GeV^{2})");
...
hpipM_119->GetYaxis()->SetLabelSize(0.11);
hpipM_119->GetYaxis()->SetRangeUser(-1000, 6500);
hpipM_119->Draw("E1");
...
hpipAc_119->SetTitle("");
hpipAc_119->GetXaxis()->SetTitle("P_{hT}^{2} (GeV^{2})");
...
hpipAc_119->GetYaxis()->SetLabelSize(0.11);
...
hpipAcc_119->GetXaxis()->SetTitle("P_{hT}^{2} (GeV^{2})");
...
hpipAcc_119->GetYaxis()->SetLabelSize(0.11);
