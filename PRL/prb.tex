...
The data set used a 5.498 GeV longitudinally polarized electron beam and an unpolarized liquid hydrogen target.
...
where $\phi_h$ is the azimuthal angle of final state hadrons with respect to the lepton scattering plane,
...
The Boer-Mulders function, discussed in the next section, is of particular interest since it gives insights into the quark angular momentum contribution to the proton spin.
...
Typically, the size of the systematic errors is comparable to the size of the statistical errors, indicating that the systematics are well controlled.
